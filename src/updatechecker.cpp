...
#define VERSION_URL "https://dl.dropboxusercontent.com/u/10965356/Altro/emoji_version.txt"
#define DESTINATION_URL "http://fasterindesign.altervista.org/software-updates/kem-version.txt"
...
void UpdateChecker::checkIfIsNewVersion(int version)
{
    if (version > globals::CURRENT_INTERNAL_VERSION) {
        int ret = QMessageBox::warning(0, tr("New version is available!"),
                                       tr("A new version of PROGRAM_NAME is available!\nWould you download it?"),
